...
const ProductDetail: React.FC = () => {
  ...
  // Update product and related products when ID changes
  useEffect(() => {
    if (id) {
      ...
      // Reset image loading state and update timestamp for cache busting
      ...
      <section className="container mx-auto container-padding mb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="relative aspect-square bg-muted rounded-lg overflow-hidden">
            ...
            <img 
              src={`${product.imageSrc}?v=${imageTimestamp}`}
              alt={product.name} 
                ...
                {product.details.colors && (
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {product.details.colors.map((color: string) => (
                        <div 
                          key={color} 
                ...
                {product.details.features && (
                  <div>
                    ...
                    <ul className="space-y-1 text-muted-foreground">
                      {product.details.features.map((feature: string) => (
